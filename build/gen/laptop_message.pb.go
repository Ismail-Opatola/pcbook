...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e,
	...
	0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x43,
	0x50, 0x55, 0x52, 0x03, 0x63, 0x70, 0x75, 0x12, 0x28, 0x0a, 0x03, 0x72, 0x61, 0x6d, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70,
	...
	0x13, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53, 0x74,
	...
	0x16, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x0b, 0x32, 0x18, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f,
...
var file_laptop_message_proto_goTypes = []interface{}{
	(*Laptop)(nil),              // 0: package.pcbook.Laptop
	(*CPU)(nil),                 // 1: package.pcbook.CPU
	(*Memory)(nil),              // 2: package.pcbook.Memory
	(*GPU)(nil),                 // 3: package.pcbook.GPU
	(*Storage)(nil),             // 4: package.pcbook.Storage
	(*Screen)(nil),              // 5: package.pcbook.Screen
	(*Keyboard)(nil),            // 6: package.pcbook.Keyboard
	(*timestamp.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: package.pcbook.Laptop.cpu:type_name -> package.pcbook.CPU
	2, // 1: package.pcbook.Laptop.ram:type_name -> package.pcbook.Memory
	3, // 2: package.pcbook.Laptop.gpus:type_name -> package.pcbook.GPU
	4, // 3: package.pcbook.Laptop.storages:type_name -> package.pcbook.Storage
	5, // 4: package.pcbook.Laptop.screen:type_name -> package.pcbook.Screen
	6, // 5: package.pcbook.Laptop.keyboard:type_name -> package.pcbook.Keyboard
	7, // 6: package.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
