...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=package.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e,
	...
	0x52, 0x41, 0x42, 0x59, 0x54, 0x45, 0x10, 0x06, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2e, 0x2f, 0x2e,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: package.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: package.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: package.pcbook.Memory.unit:type_name -> package.pcbook.Memory.Unit
