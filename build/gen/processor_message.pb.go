...
type CPU struct {
	...
	NumberThreds uint32  `protobuf:"varint,4,opt,name=number_threds,json=numberThreds,proto3" json:"number_threds,omitempty"`
...
func (x *CPU) GetNumberThreds() uint32 {
	if x != nil {
		return x.NumberThreds
	}
	return 0
}
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x70, 0x61, 0x63, 0x6b, 0x61,
	0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
	...
	0x68, 0x72, 0x65, 0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x54, 0x68, 0x72, 0x65, 0x64, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x69, 0x6e,
	...
	0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x47, 0x68, 0x7a, 0x22, 0x91, 0x01, 0x0a, 0x03,
	...
	0x11, 0x5a, 0x0f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x2f, 0x67,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: package.pcbook.CPU
	(*GPU)(nil),    // 1: package.pcbook.GPU
	(*Memory)(nil), // 2: package.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: package.pcbook.GPU.memory:type_name -> package.pcbook.Memory
