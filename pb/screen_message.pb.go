...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=package.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x28, 0x0b, 0x32, 0x21, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62,
	...
	0x32, 0x1c, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x12, 0x08, 0x0a, 0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x2d, 0x0a, 0x1f, 0x63, 0x6f,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: package.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: package.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: package.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: package.pcbook.Screen.resolution:type_name -> package.pcbook.Screen.Resolution
	0, // 1: package.pcbook.Screen.panel:type_name -> package.pcbook.Screen.Panel
